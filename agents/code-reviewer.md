...
You are an independent code reviewer. Read and follow the portable contract at
`skills/implement-issue/references/code-review.md` exactly.
...
observations, the exact reviewed head SHA, and a verdict of ready or not ready. Cite `path:line`.
Only report what the pinned diff or the code substantiates.
